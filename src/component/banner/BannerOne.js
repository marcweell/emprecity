                    ...
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <AnimationOnScroll animateIn="fadeInUp" animateOnce={true} delay={100}>
                                <h1 className="title">Expertos en Ecommerce &amp; publicidad</h1>
                                <span className="subtitle">Te ayudamos a hacer crecer tu empresa de forma escalable aplicando Inteligencia Artificial.</span>
                                <Link to={process.env.PUBLIC_URL + "/contact"} className="axil-btn btn-fill-primary btn-large">¿Empezamos?</Link>
                            </AnimationOnScroll>
                        </div>
                    </div>
                    <div className="col-lg-6">
