...
import PricingData from "../../data/pricing/PricingDataDisenoWeb.json";
                        ...
                        <div className="pricing-table pricing-borderd">
                            <div className="pricing-header">
                                ...
                                <div className="pricing-btn">
                                    <Link to="#" className="axil-btn btn-large btn-borderd">Empezar Diseño web {data.ahorro}</Link>
...
export default PricingDisenoWeb;